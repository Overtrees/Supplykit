...
const WH_COLS = {
  ...
  platform: [
    {id:'channel',label:'平台'},{id:'warehouse',label:'仓库'},{id:'brand',label:'品牌'},{id:'sku',label:'SKU'},{id:'barcode',label:'69码'},{id:'name',label:'商品'},
