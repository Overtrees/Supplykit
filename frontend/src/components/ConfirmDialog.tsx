...
export default function ConfirmDialog({ open, title, desc, confirmLabel = '{t("ommon.confirm")}', cancelLabel = '{t("ommon.cancel")}', onConfirm, onCancel, danger }: ConfirmDialogProps) {
  if (!open) return null
