...
export default function InsightsPage() {
  ...
  const { channel: globalChannel, hammerInsightsTab: tab, hammerReplenMode, setHammerReplenMode, hammerCols, hammerData, dataVersion, pageVersion } = useAppStore()
  ...
  }, [globalChannel, replenMode, dataVersion, pageVersion])
