      ...
      {showCustom && <div style={{borderTop:'1px solid var(--border)',paddingTop:8,marginTop:8}}>
        <div style={{display:'flex',gap:3,alignItems:'center',marginBottom:6}}>
          <input type="date" value={startVal} onChange={e=>setStartVal(e.target.value)}
            style={{flex:1,width:0,minWidth:0,padding:'3px 5px',fontSize:11,border:'1px solid var(--border)',borderRadius:99,outline:'none',background:'var(--card)',color:'var(--text)',boxSizing:'border-box'}} />
          <span style={{color:'var(--muted2)',fontSize:9,flexShrink:0}}>~</span>
