...
export const getInvVis = (wt) => { try { return JSON.parse(localStorage.getItem(INV_COL_KEY + '_' + wt) || 'null') } catch{return null} }
...
export const INS_BBCC_COLS = [
  ...
  {id:'combined_turn',label:'当前综转'},{id:'after_turn',label:'补后综转'},{id:'days',label:'可撑天数'},{id:'note',label:'备注'},
]
export const INS_TRAD_COLS = [
  {id:'seq',label:''},{id:'sku',label:'SKU'},{id:'barcode',label:'69码'},{id:'name',label:'商品'},{id:'warehouse',label:'仓库'},
  {id:'avail',label:'现有'},{id:'transit',label:'在途'},{id:'sales',label:'日销(融合/7/14/28)'},{id:'safety',label:'安全线'},
  {id:'turnover',label:'在库周转'},{id:'after_turnover',label:'补后周转'},{id:'suggested',label:'建议补'},{id:'note',label:'备注'},
]
export const INS_PURCHASE_COLS = [
  {id:'barcode',label:'69码'},{id:'sku',label:'SKU'},{id:'name',label:'商品'},{id:'warehouse',label:'仓库'},
  {id:'sys_total',label:'系统总库存'},{id:'sales',label:'日销(融合/14/28)'},{id:'actual_purchase',label:'建议采购(含箱规取整)'},
  {id:'after_turnover',label:'补后周转'},{id:'note',label:'备注'},{id:'timing',label:'采购时机'},
]
export const INS_SLOW_COLS = [
  {id:'sku',label:'SKU'},{id:'barcode',label:'69码'},{id:'name',label:'商品'},{id:'last_order',label:'最近下单'},
  {id:'days',label:'天数'},{id:'stock',label:'库存'},{id:'level',label:'级别'},
]
