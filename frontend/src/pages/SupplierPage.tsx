...
return<div className='card'><div className='section-title' style={{display:'flex',flexWrap:'wrap',gap:6,alignItems:'center'}}>
  <span>供应商管理 <span className='small muted'>{t("common.total")} {list.length} {t("ommon.items")}</span></span>
</div>
{fl.length===0?<EmptyState icon='factory' title={s?'{t("upplier.empty_matched")}':'{t("upplier.empty")}'}/>:<div style={{overflowX:"auto"}}>
