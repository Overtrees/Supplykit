      ...
      <header>
        <div className="header-inner">
          <div className="header-left">
            ...
            <select value={channel} onChange={e=>{const v=e.target.value;localStorage.setItem('c_channel', v);useAppStore.setState({channel:v, channelVersion:Date.now(),dataLoaded:false,loading:true});useAppStore.getState().loadAll()}} style={{marginLeft:8,fontSize:13,padding:'3px 8px',border:'1px solid var(--border)',borderRadius:32,outline:'none',background:'var(--sidebar)',color:'var(--text)',cursor:'pointer'}}>
